// ==========================================
// SST-COMPARATOR ENGINE (UNIFIED V2.7)
// ==========================================
...
let currentProjectMetadata = {
    ...
    pages_milled: "N/A",
    engine_version: "SST_HammerX_V2.7"
};
...
// Purge Project Records from Database & Storage
async function purgeCurrentProject(projectId, storagePath = null) {
    if (!supa || !projectId) return;
    ...
    try {
        ...
        if (storagePath) {
            await supa.storage.from('hammer-assets').remove([storagePath]);
        }

        alert("Project purged from Supabase.");
