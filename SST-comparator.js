...
// 1 & 2. Toggle Courseware Display Modes & Handle [what] Visibility
...
async function autoSavePreferencesOnSettingsExit() {
    ...
    try {
        ...
        if (!error) {
            ...
            console.log("Settings synced to cloud profile.");
        }
    } catch (err) {
...
// ==========================================
// FORMULA VERBATIM NORMALIZATION ENGINE
// ==========================================
...
function parseLineToTokens(rawText) {
    ...
    let tokenHtml = '';
    if (tag) {
        tokenHtml += `<span class="line-part-tag ${isWhatTag ? 'tag-what' : ''} dim-expanded-tag" data-field="tag">${displayTag}</span> `;
    }
...
// ==========================================
// SYNCHRONIZED MEMORY STATE (ACTIVE & MASTER)
// ==========================================
...
// Binds immediately to window for inline onclick in tabs
...
// ==========================================
// UNIVERSAL 9-TAG PAYLOAD DISTRIBUTOR
// ==========================================
...
async function populateCloudProjectsDropdown() {
    ...
    try {
        ...
        if (!items || items.length === 0) {
            dropdown.innerHTML = '<option value="">No projects found for your account</option>';
            return;
        }

        const promptOpt = document.createElement('option');
        promptOpt.value = "";
        promptOpt.textContent = "-- SELECT YOUR CLOUD PROJECT --";
    ...
    try {
        ...
        if (typeof payload === 'string') {
            try {
                ...
                console.warn("[SST] Raw payload parse pass:", e);
            }
        }
...
// ==========================================
// DOM INITIALIZATION & EVENT ATTACHMENT
// ==========================================
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (shutterHeader) {
        ...
        shutterHeader.addEventListener('click', (e) => {
    ...
    if (userProfileTrigger && rightDrawer) {
        ...
        jsonFileInput.addEventListener('change', (event) => {
            ...
            reader.onload = function(e) {
                try {
                    ...
                    if (btnStudy && displayStudy) switchView(displayStudy, btnStudy);
                } catch (err) {
    ...
    if (btnApplyHex && inputHex) {
        btnApplyHex.addEventListener('click', () => {
            ...
            // Clean plain-JavaScript logical OR (fixed regex)
